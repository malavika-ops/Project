    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="navbar">
                ...
                <ul class="menu">
                    ...
                    <li class="menu1"><a class="amenu1" href="home.php">Home</a></li>
                ...
                <a class="button1" href="loginregistration.php">Login/Register</a>
            ...
            <div class="mediamenu">
                ...
                <li class="menu1"><a class="amenu1" href="home.html">Home</a></li>
                <li class="menu2"><a class="amenu2" href="#aboutus">About</a></li>
                <li class="menu1"><a class="amenu1" href="#courses">Courses</a></li>
                <li class="menu3"><a class="amenu3" href="#contactus">Contact</a></li>

                <li class="menu4"><a class="button1" href="loginregistration.php">Login/Register</a></li>
        ...
        <section id="homecontent">
            ...
            <div class="content">
                ...
                <a class="content3" href="loginregistration.php">Start Training</a>
