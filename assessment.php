<?php
    ...
    $assessquery = "SELECT id, title FROM assessments";
    $assessresult = $conn->query($assessquery);

    $assessment = [];
        if($assessresult->num_rows > 0){
            while($row = $assessresult->fetch_assoc()){
                $assessment[] = $row;
            }
        }
                    ...
                    <ul class="menucontent">
                        ...
                        <li class="menulinks">
                            ...
                            <a href="assessment.php">
                                ...
                                <i class='bx bxs-edit menuicon active'></i>
        ...
        <div class="assessments">
            ...
            <div class="assessmentlist">
                ...
                <div class="assessmentitem">
                    ...
                    <a href="cra.php?id=<?php echo htmlspecialchars($assessment['id']); ?>">Take Assessment</a>
