document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const addLearnedButton = document.getElementById('addLearnedButton');
    const learnedText = document.getElementById('learnedText');
    const learnedForm = document.getElementById('learnedForm');

    learnedForm.addEventListener('submit', function(event){

        if(learnedText.value.trim() === ''){
            alert("Please enter what you've learned today.");
